...
- Основной namespace приложений и компонентов: `App\Addressing\`.
...
- При расхождении правила синхронизируются в обоих местах, но AGENTS.md только расшмением.
...
- старые tokens и aliases удаляются после обновления callers;
...
prod \www\App\Addressing\config\kernel\runtime_scope.prod.lock
dev \www\App\Addressing\config\kernel\runtime_scope.prod.lock
