...
abstract readonly class AbstractDoctrineAddressRepository
{
    ...
    protected function appendEvidenceSnapshotInternal(AddressInterface $address, AddressEntity $entity): ?AddressEvidenceSnapshotInterface
    {
        ...
        $addressEvidenceSnapshotEntity = $this->mapper->toDoctrineSnapshot($addressEvidenceSnapshot, $entity);
        $this->entityManager->persist($addressEvidenceSnapshotEntity);
    ...
    protected function appendOutbox(string $nameEntity, array $payload): void
    {
        ...
        $addressOutboxEntity = (new AddressOutboxEntity())
    ...
    protected function fetchFilteredAddresses(
        ...
        $this->applyAddressScope($queryBuilder, 'a', $ownerId, $vendorId, $countryCode, $q);
        $this->applyAddressFilters($queryBuilder, 'a', $filters, $includeSourceSystem, $includeValidation, $includeNormalization);
