...
$checks = [
    ...
    'config/address_deptrac.yaml' => is_file($root.'/config/address_deptrac.yaml'),
    'src/Doctrine/AddressDoctrineSchemaManager.php' => is_file($root.'/src/Doctrine/AddressDoctrineSchemaManager.php'),
    'src/Builder/Persistence/AddressTenantScopeSqlBuilder.php' => is_file($root.'/src/Builder/Persistence/AddressTenantScopeSqlBuilder.php'),
    'src/Plan/Persistence/AddressValidatedMutationPlan.php' => is_file($root.'/src/Plan/Persistence/AddressValidatedMutationPlan.php'),
