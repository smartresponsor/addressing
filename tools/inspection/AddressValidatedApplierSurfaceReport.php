...
$tenantScopeHelperPath = $root.'/src/Builder/Persistence/AddressTenantScopeSqlBuilder.php';
$mutationPlanPath = $root.'/src/Plan/Persistence/AddressValidatedMutationPlan.php';
...
fwrite(STDOUT, json_encode([
    ...
    'checks' => [
        ...
        'src/Builder/Persistence/AddressTenantScopeSqlBuilder.php' => is_file($tenantScopeHelperPath),
        'src/Plan/Persistence/AddressValidatedMutationPlan.php' => is_file($mutationPlanPath),
    ...
    'signals' => [
        ...
        'validatedApplierInjectsTenantScopeSqlHelper' => str_contains($serviceContent, 'private AddressTenantScopeSqlBuilder $addressTenantScopeSqlHelper'),
