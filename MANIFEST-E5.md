...
- src/Integration/Geocode/NominatimAdapter.php — forward/forwardByParts/reverse; env-driven base URL & User-Agent; maps
  to GeocodeResult
...
- Обязателен корректный User-Agent для Nominatim. Реальный HTTP-клиент — SimpleHttpClient; в проде можно заменить на
  Guzzle.
